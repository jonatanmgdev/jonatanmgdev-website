      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="flex">
            ...
            <p className="animate-slideinDown font-bold text-2xl text-primary-dark">
              .
            </p>
            <p className="animate-slideinRight font-normal text-2xl text-primary-dark">
              dev
            </p>
          </div>
          <ul className="list-none animate-slideinRight flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
            <li>
        ...
        <div className="animate-slideinLeft sm:flex sm:items-center sm:justify-between">
          ...
          <div className="animate-slideinRight flex mt-4 sm:justify-center sm:mt-0 gap-4">
            <a
