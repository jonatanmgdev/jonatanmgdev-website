        ...
        <div className="md:w-1/2 mb-4 md:mb-0 animate-slideinLeft">
          <div className="lg:max-w-lg">
            ...
            <p className="mt-4 text-md sm:text-base md:text-xl">
              ...
              usuario. Me considero una persona detallista, organizada y
              creativa.
            </p>
            <div className="flex flex-col md:flex-row md:items-center items-start justify-start gap-4 mt-6">
              ...
              <div className="flex flex-col md:flex-row  md:items-start justify-start gap-4">
                <div className="flex justify-center items-center  gap-4">
                  <a className="text-[--quinary-color] hover:text-[--tertiary-color]" href="https://www.youtube.com/@jonatanmgdev">
                    {IconYoutube(35)}
                    <span className="sr-only">Mi cuenta en Youtube</span>
                  </a>
                  <a className="text-[--quinary-color] hover:text-[--tertiary-color]" href="https://github.com/jonatanmgdev">
                    {IconGithub(35)}
                    <span className="sr-only">Mi cuenta en GitHub</span>
                  </a>
                  <a className="text-[--quinary-color] hover:text-[--tertiary-color]" href="https://www.linkedin.com/in/jonatanmgdev/">
                    {IconLinkedin(35)}
