"use server";
import welcomeBackground from "@assets/images/welcome-code-bg.jpg";

export default async function WelcomeComponent() {
  return (
    <section
      className="bg-[--secondary-color] bg-no-repeat bg-cover bg-center shadow-lg"
      style={{ backgroundImage: `url('${welcomeBackground.src}')` }}
    >
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                ...
                <h1 className="animate-slideinLeft mt-2 sm:text-4xl">
                  Jonatan Montesdeoca
                </h1>
                <p className="animate-slideinLeft mt-6 text-xl leading-8">
                  Diseño y desarrollo soluciones digitales a medida, creando proyectos
                 con enfoque en la usabilidad y la experiencia del
                  usuario. Me considero una persona autodidacta, organizada y
                  creativa.
                </p>
                <div className="animate-slideinLeft flex items-center gap-[18px] flex-wrap mt-[30px]">
                  <div className="flex items-center flex-wrap gap-[15px] sm:justify-center">
                    <button type="button" className="btn-primary shrink-0">
                      Sobre mí
                    </button>
                    <span className="text-[--quinary-color] lg:text-[16px] md:text-[14px] font-normal shrink-0">
                      Sígueme:{" "}
                    </span>
                    <div className="flex sm:justify-center sm:mt-0">
                      <a
                        href="#"
                        className="text-[--quinary-color] hover:text-[--tertiary-color]"
                      >
                        <svg
                      ...
                      <a
                        href="#"
                        className="text-[--quinary-color] hover:text-[--tertiary-color]  ms-5"
                      >
                        <svg
                          className="w-8 h-8"
                          aria-hidden="true"
